...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$input = $(`
		<input maxlength="15" onkeyup="characterCheck(this)" onkeydown="characterCheck(this)" class="test" type="${this.type}" name="${this.name}" placeholder="${this.placeholderText}"/>
