          ...
          <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-7 col-sm-10 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="col-12">
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="mid" class="form-control your-input" 
                               placeholder="아이디" id="yourUsername" required>
                    ...
                    <div class="col-12" style="margin-top:1px;">
                      <div class="input-group has-validation">
                        ...
                        <input type="password" name="mpassword" class="form-control your-input" 
                              placeholder="비밀번호" id="yourPassword" required>
              ...
              <div class="credits">
                <ul class="find-info">
                  <li>
                  	<a class="link-text" href="/member/register">비밀번호 찾기</a>
                  </li>
                  <li>
                  	<a class="link-text" href="/member/register">아이디 찾기</a>
                  </li>
                  <li>
                  	<a class="link-text" href="/member/register">회원가입</a>
                  </li>
                </ul>
              </div>
