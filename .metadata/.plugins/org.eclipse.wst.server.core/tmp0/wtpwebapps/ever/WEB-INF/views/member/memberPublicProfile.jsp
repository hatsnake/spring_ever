    	...
    	<div class="clearfix">
			<div class="float-start d-flex align-items-start mt-2"> 
				...
				<div class="w-100 ms-3">
					<div class="fw-bold fs-5">모자뱀(hatsnake)</div>
					<div style="font-size:14px;">침팬치</div>
					<div>
						<span class="me-1">
							<span style="font-size:14px; color:gray;">방문</span> 
							<span style="font-size:14px; font-weight:bold;">${visitedCount}</span>
						</span>
						<span class="me-1">
							<span style="font-size:14px; color:gray;">작성글</span> 
							<span style="font-size:14px; font-weight:bold;">${articleCount}</span>
						</span>
						<span>
							<span style="font-size:14px; color:gray;">작성 댓글</span> 
			...
			<div class="card-body pt-3">
              <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#bordered-article" type="button" role="tab" aria-controls="home" aria-selected="true">작성글</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#bordered-comment" type="button" role="tab" aria-controls="profile" aria-selected="false">댓글단 글</button>
                </li>
              </ul>
